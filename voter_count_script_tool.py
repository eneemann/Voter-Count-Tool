...
arcpy.AddMessage("The script start time is {}".format(readable_start))
...
# Start timer for Summarize Within portion, get timestamp for FC name
...
arcpy.AddMessage("The script end time is {}".format(readable_end))
arcpy.AddMessage("Time elapsed in section: {:.2f}s".format(time.time() - section_time))